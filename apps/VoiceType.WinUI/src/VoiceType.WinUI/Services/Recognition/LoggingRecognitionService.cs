...
public sealed class LoggingRecognitionService : IRecognitionService
{
    ...
    {
        _telemetry.LogInfo("Recognition", "Stopping and cleaning up recognition...");
        await _inner.StopAndCleanupAsync();
    }
    ...
    {
        _telemetry.LogInfo("Recognition", "Applying runtime settings");
        _inner.ApplyRuntimeSettings(settings);
    }
}