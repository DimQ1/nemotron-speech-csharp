...
```powershell
python tools/converters/NemotronAsr/src/optimize.py --encoder-precision fp16 --execution-provider cuda
```

The output is `tools/converters/NemotronAsr/src/build/onnx_models_fp16_cuda/`. The pipeline
