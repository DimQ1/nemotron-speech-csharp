...
Output: models/asr/nemotron-3.5/onnx/qnn/ with encoder.onnx, decoder.onnx, joint.onnx,
        genai_config.json, audio_processor_config.json, tokenizer, Silero VAD.

Usage:
    cd tools/converters/NemotronAsr
...
# --------------- defaults ---------------
DEFAULT_NEMO = str(_PROJECT_ROOT / "models" / "asr" / "nemotron-3.5" / "source" / "nemotron-3.5-asr-streaming-0.6b.nemo")
DEFAULT_OUTPUT = str(_PROJECT_ROOT / "models" / "asr" / "nemotron-3.5" / "onnx" / "qnn")
...
def main():
    ...
    if not Path(model_path).exists():
        ...
        print("  Download from HuggingFace or place .nemo in models/asr/nemotron-3.5/source/")
        sys.exit(1)
