...
public class ModelSessionCpuThreadBenchmark
{
    ...
    {
        var modelPath = Path.Combine(FindRepoRoot(), "models", "asr", "nemotron-3.5", "onnx", "cpu-int4");
    ...
    private static string FindRepoRoot()
    {
        ...
        {
            if (Directory.Exists(Path.Combine(directory.FullName, "models", "asr", "nemotron-3.5", "onnx")) &&
