...
/// </summary>
public sealed class MetricsRecognizerDecorator : IStreamingSpeechRecognizer, ILanguageConfigurable, IRuntimeConfigurable
{
...
/// </summary>
public sealed class LoggingRecognizerDecorator : IStreamingSpeechRecognizer, ILanguageConfigurable, IRuntimeConfigurable
{
    private readonly IStreamingSpeechRecognizer _inner;
